...
public: 
  nonfunc_add(unsigned long i0,UNSIGNED_SCORE_STREAM i1,UNSIGNED_SCORE_STREAM i2);
...
void *NEW_nonfunc_add(unsigned long i0,UNSIGNED_SCORE_STREAM i1,UNSIGNED_SCORE_STREAM i2);
#endif
